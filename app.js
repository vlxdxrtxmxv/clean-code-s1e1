...
var incompleteTaskHolder = document.getElementById("functionality__incomplete-tasks"); //ul of #incompleteTasks
...
var createNewTaskElement = function(taskString) {
  ...
  listItem.className = "functionality__incomplete-tasks__task task"
  ...
  checkBox.className = "functionality__incomplete-tasks__task__checkbox checkbox"
  editInput.type = "text";
  editInput.className = "functionality__incomplete-tasks__task__text task-input";

  editButton.innerText = "Edit"; //innerText encodes special characters, HTML does not.
  editButton.className = "functionality__incomplete-tasks__task__edit btn-edit btn";

  deleteButton.className = "functionality__incomplete-tasks__task__delete btn-delete btn";
  deleteButtonImg.className = "functionality__incomplete-tasks__task__delete__img delete-img"
...
var taskIncomplete = function() {
  ...
  var listItem = this.parentNode;
  if (listItem.classList.contains("edit-tasks")) {
    listItem.classList = "functionality__incomplete-tasks__task task edit-tasks"

  } else {
    listItem.classList = "functionality__incomplete-tasks__task task"
  }
  listItem.children[0].classList = "functionality__incomplete-tasks__task__checkbox checkbox"
  listItem.children[1].classList = "functionality__incomplete-tasks__task__description task-description"
  listItem.children[2].classList = "functionality__incomplete-tasks__task__text task-input"
  listItem.children[3].classList = "functionality__incomplete-tasks__task__edit btn-edit btn"
  listItem.children[4].classList = "functionality__incomplete-tasks__task__delete btn-delete btn"
  listItem.children[4].children[0].classList = "functionality__incomplete-tasks__task__delete__img delete-img"
  incompleteTaskHolder.appendChild(listItem);
  bindTaskEvents(listItem, taskCompleted);
}
